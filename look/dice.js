...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-98f5ae30');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-98f5ae30');}
...
function clearFlash(){dieView.classList.remove('rl-win-98f5ae30');dieView.classList.remove('rl-lose-98f5ae30');if(frameEl){frameEl.classList.remove('rl-win-98f5ae30');frameEl.classList.remove('rl-lose-98f5ae30');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-98f5ae30');if(frameEl){frameEl.classList.add('rl-win-98f5ae30');}}else{dieView.classList.add('rl-lose-98f5ae30');if(frameEl){frameEl.classList.add('rl-lose-98f5ae30');}}
...
var brandEl=document.querySelector('.rl-brand-98f5ae30');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
